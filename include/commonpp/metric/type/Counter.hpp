...
#define USE_TBB 1
#define USE_ATOMIC 2
#define USE_SPINLOCK 3

#ifndef SHARED_COUNTER_BACKEND
# define SHARED_COUNTER_BACKEND USE_TBB
#endif

#include <functional>

#if SHARED_COUNTER_BACKEND == USE_TBB
# include <tbb/combinable.h>
#elif SHARED_COUNTER_BACKEND == USE_SPINLOCK
# include <mutex>
# include <commonpp/thread/Spinlock.hpp>
#elif SHARED_COUNTER_BACKEND == USE_ATOMIC
# include <atomic>
#endif
...
private:
#if SHARED_COUNTER_BACKEND == USE_SPINLOCK
